      ...
      <div class="navbar-collapse collapse" id="navbarColor01">
        <ul class="navbar-nav me-auto">
          ...
          if (isset($_SESSION['user']['username'])) {
            echo '<li>';
            echo '<a class="nav-link" href="./newactu.php">cree une actu</a>';
            echo '</li>';
            echo '<li>';
            echo '<span  title=deconnexion>';
            echo '<a class="nav-link" href="./deco.php"><i class="fa-solid fa-door-open"></i></a>';
            echo '</span>';
            echo '</li><a>';
          }
          ?>
